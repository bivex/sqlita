...
from sqlita.domain.model import ParsingJob
from sqlita.domain.ports import Clock, DomainEventPublisher, ParsingJobRepository
...
class StructuredLoggingEventPublisher(DomainEventPublisher):
    def __init__(self, logger: logging.Logger | None = None) -> None:
        self._logger = logger or logging.getLogger("sqlita.events")
